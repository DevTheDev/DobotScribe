...
%DURING THE SESSION
RobotRaconteur.StartLocalServer('experimental.MatlabTestServer');
RobotRaconteur.StartTcpServer(10001);

%Define a service definition
servicedef1=['service experimental.MatlabTestService\n\n' ...
...
RobotRaconteur.RegisterService('MatlabTestService','experimental.MatlabTestService.MatlabTestObject',o);
